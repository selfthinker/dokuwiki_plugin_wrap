 ...
 */
$lang['noPrefix']              = 'Какие (разделенные запятыми) имена классов должны быть исключены из классов с префиксом "wrap_"?';
$lang['restrictedClasses']     = 'Классы плагина, которые нельзя использовать (перечислите через запятую)';
$lang['restrictionType']       = 'тип ограничения, указывает, если классы должны быть включены или исключены';
